...
{ PCI_VENDOR_ID_ATI, PCI_DEVICE_ID_ATI_RADEON_Yd, "" },
...
/* vesafb */
/* It doesn't allow to set an arbitrary video mode */
...
{ PCI_VENDOR_ID_SI, PCI_DEVICE_ID_SI_315H, "" },
{ PCI_VENDOR_ID_SI, PCI_DEVICE_ID_SI_315, "" },
{ PCI_VENDOR_ID_SI, PCI_DEVICE_ID_SI_315PRO, "" },
{ PCI_VENDOR_ID_SI, PCI_DEVICE_ID_SI_550_VGA, "" },
{ PCI_VENDOR_ID_SI, PCI_DEVICE_ID_SI_650_VGA, "" },
{ PCI_VENDOR_ID_SI, PCI_DEVICE_ID_SI_330, "" },
{ PCI_VENDOR_ID_SI, PCI_DEVICE_ID_SI_660_VGA, "" },
