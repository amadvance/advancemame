...
*/
#define ENABLE_FAST_BG_DRAW 0 // if enabled, inaccurate, but faster background drawing is enabled
...
static void draw_sprites(mame_bitmap *bitmap)
{
	...
	while (source < finish)
	{
		...
		tileno = (source[1] & 0x0001ffff) >>0; // For Cute Fighter Sprites 
...
{
	dreamwld_bg_tilemap = tilemap_create(get_dreamwld_bg_tile_info, tilemap_scan_rows, TILEMAP_OPAQUE, 16, 16, 64,64); // for Gaialast changed to 16,16,64,64
...
static MACHINE_DRIVER_START( dreamwld )
	...
	MDRV_SOUND_ADD(OKIM6295, MASTER_CLOCK/32/165) // pin is low so 165 
	MDRV_SOUND_CONFIG(okim6295_interface_region_1)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "left", 0.50)
	MDRV_SOUND_ROUTE(ALL_OUTPUTS, "right", 0.50)

	MDRV_SOUND_ADD(OKIM6295, MASTER_CLOCK/32/165)
...
/*
GAME( 1997, baryon,   0, dreamwld,  baryon,   0, ROT270,  "SemiCom / Tirano", "Baryon - Future Assault", 0 )
GAME( 1999, rolcrush, 0, dreamwld,  rolcrush, 0, ROT0,    "SemiCom / Exit",   "Rolling Crush (version 1.07.E - 1999/02/11)", GAME_IMPERFECT_GRAPHICS ) // wrong linescroll?
GAME( 1998, cutefght, 0, dreamwld,  cutefght, 0, ROT0,    "SemiCom",          "Cute Fighter", GAME_IMPERFECT_GRAPHICS ) // wrong linescroll?
GAME( 1999, gaialast, 0, dreamwld,  gaialast, 0, ROT0,    "SemiCom / XESS",   "Gaia - The Last Choice of Earth", 0)
*/
