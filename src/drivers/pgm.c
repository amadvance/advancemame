...
// installed over rom
READ32_HANDLER(svg_speedup_r )
{
	int pc = activecpu_get_pc();
	if (pc == 0xb90) activecpu_eat_cycles(500); // correct i think
	return armrom[0xb90/4];
}

static void armsim_svg(void)
{
	UINT16 *temp16 = (UINT16 *) memory_region(REGION_CPU3);
...
//	armrom = (UINT32 *) memory_region(REGION_CPU3);
//	memory_install_read32_handler(2, ADDRESS_SPACE_PROGRAM, 0xB90, 0xB93, 0, 0, ssv_speedup_r);
}
...
ROM_START( svg )
	...
	ROM_LOAD( "svg.u26.bin", 0x000000, 0x400000, CRC(46826ec8) SHA1(ad1daf6f615fb8d748ce7f98f19dd3bf22f79fba) )
	ROM_LOAD( "svg.u29.bin", 0x400000, 0x400000, CRC(fa5f3901) SHA1(8ab7c6763df4f752b50ed2197063f58046b32ddb) )
