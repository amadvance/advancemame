...
ROM_START( hedpanic )
	...
	ROM_REGION( 0x44000, REGION_CPU2, 0 )		/* Z80 Code */
	ROM_LOAD( "esd3", 0x00000, 0x0c000, CRC(a88d4424) SHA1(eefb5ac79632931a36f360713c482cd079891f91)  ) // 0x040000 of data repeated 2x
	ROM_CONTINUE(     0x10000, 0x34000)
	...
	ROM_REGION( 0x40000, REGION_SOUND1, 0 )	/* Samples */
	ROM_LOAD( "esd4", 0x000000, 0x020000, CRC(3c11c590) SHA1(cb33845c3dc0501fff8055c2d66f412881089df1)  ) // 0x020000 of data repeated 4x
ROM_END
