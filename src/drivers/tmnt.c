...
static READ16_HANDLER( ssriders_protection_r )
{
	...
	switch (cmd)
	{
		...
		case 0x8abc:
			...
			data += ((program_read_word(0x105cb0) + program_read_word(0x1040c8) - 6) / 8 + 12) & 0x3f;
 			return data;
...
GAME( 1993, prmrsocr, 0,        prmrsocr, prmrsocr, glfgreat, ROT0,  "Konami", "Premier Soccer (ver EAB)", GAME_NOT_WORKING )
