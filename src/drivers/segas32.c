...
INPUT_PORTS_START( orunners )
	...
	PORT_MODIFY("P1_A")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_PLAYER(1) /* shift up */
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_PLAYER(1) /* shift down */
	PORT_BIT( 0xfc, IP_ACTIVE_LOW, IPT_UNKNOWN )
...
INPUT_PORTS_START( radm )
	...
	PORT_MODIFY("P1")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_NAME("Light")
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_NAME("Wiper")
	PORT_BIT( 0xf8, IP_ACTIVE_LOW, IPT_UNUSED )
...
INPUT_PORTS_START( radr )
	...
	PORT_MODIFY("P1")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_NAME("Gear Change") PORT_TOGGLE
	PORT_BIT( 0xfe, IP_ACTIVE_LOW, IPT_UNUSED )
...
static MACHINE_DRIVER_START( system32 )
	...
	MDRV_VISIBLE_AREA(0*8, 320-1, 0*8, 28*8-1)
...
static MACHINE_DRIVER_START( multi32 )
	...
	MDRV_VISIBLE_AREA(0*8, 640/2-1, 0*8, 28*8-1)
	MDRV_GFXDECODE(gfxdecodeinfo)
...
GAME( 1993, f1lap,    0,        system32,     f1lap,    f1lap,    ROT0, "Sega",   "F1 Super Lap", GAME_IMPERFECT_GRAPHICS | GAME_NOT_WORKING ) // not passing the "networking check"
