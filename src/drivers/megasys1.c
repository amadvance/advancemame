...
static ADDRESS_MAP_START( writemem_C, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x0e0000, 0x0e3fff) AM_MIRROR(0x4000) AM_RAM AM_WRITE(megasys1_scrollram_0_w) AM_BASE(&megasys1_scrollram[0])
	AM_RANGE(0x0e8000, 0x0ebfff) AM_MIRROR(0x4000) AM_RAM AM_WRITE(megasys1_scrollram_1_w) AM_BASE(&megasys1_scrollram[1])
	AM_RANGE(0x0f0000, 0x0f3fff) AM_MIRROR(0x4000) AM_RAM AM_WRITE(megasys1_scrollram_2_w) AM_BASE(&megasys1_scrollram[2])
