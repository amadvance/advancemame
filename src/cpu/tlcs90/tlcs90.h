...
void tmp90840_get_info(UINT32 state, union cpuinfo*);
void tmp90841_get_info(UINT32 state, union cpuinfo*);
void tmp91640_get_info(UINT32 state, union cpuinfo*);
void tmp91641_get_info(UINT32 state, union cpuinfo*);
