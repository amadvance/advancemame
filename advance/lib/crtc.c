...
video_error crtc_adjust_clock(video_crtc* crtc, const video_monitor* monitor) {
	...
	if (best_hclock_found) {
		...
		video_error_description_nolog_set("The video mode is incompatible with the monitor limitations");
		return -1;
	}
}
 ...
 */
static video_error crtc_find_exact(unsigned req_vtotal, double req_vclock, const video_monitor* monitor) {
 ...
 */
static video_error crtc_find_nearest_vclock(unsigned req_vtotal, double* req_vclock, const video_monitor* monitor) {
	double vclock;
 ...
 */
static video_error crtc_find_nearest_vtotal(unsigned* req_vtotal, double* req_vclock, const video_monitor* monitor) {
	int vtotal;
 ...
 */
static video_error crtc_find_nearest_vtotal_fix_vclock(unsigned* req_vtotal, double req_vclock, const video_monitor* monitor) {
	int vtotal;
	unsigned best_vtotal = 0;
	int best_found = 0;
	int j;
