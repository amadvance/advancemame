...
/** \file
 * Internal interface for the "dos" host.
 */
...
#if defined(USE_VIDEO_SVGALINE) || defined(USE_VIDEO_VGALINE) || defined(USE_VIDEO_VBELINE) || defined(USE_VIDEO_VBE)
#define USE_VIDEO
#endif
...
/**
 * Check if a broken BIOS is present.
 */
