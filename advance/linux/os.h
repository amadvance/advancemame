...
#ifdef __MSDOS__
#error This module is not for MSDOS
#endif
...
#define OS_KEY_TILDE SCANCODE_GRAVE
...
#define OS_KEY_DEL_PAD SCANCODE_KEYPADPERIOD
#define OS_KEY_ENTER_PAD SCANCODE_KEYPADENTER
#define OS_KEY_PRTSCR SCANCODE_PRINTSCREEN
#define OS_KEY_PAUSE SCANCODE_BREAK
#define OS_KEY_YEN 0x73 /* not defined by SVGALIB */
#define OS_KEY_YEN2 0x7d /* not defined by SVGALIB */
#define OS_KEY_KANA 0x70 /* not defined by SVGALIB */
#define OS_KEY_HENKAN 0x79 /* not defined by SVGALIB */
#define OS_KEY_MUHENKAN 0x7b /* not defined by SVGALIB */
...
#define OS_KEY_MENU 0x5d /* not defined by SVGALIB */
...
/* The codes not defined by SVGALIB are copied from the Allegro library */
/* from the file src/misc/pckeys.c */
