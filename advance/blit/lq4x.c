...
void lq4x_16_def(interp_uint16* __restrict__ dst0, interp_uint16* __restrict__ dst1, interp_uint16* __restrict__ dst2, interp_uint16* __restrict__ dst3, const interp_uint16* __restrict__ src0, const interp_uint16* __restrict__ src1, const interp_uint16* __restrict__ src2, unsigned count)
{
	unsigned i;
...
void lq4x_32_def(interp_uint32* __restrict__ dst0, interp_uint32* __restrict__ dst1, interp_uint32* __restrict__ dst2, interp_uint32* __restrict__ dst3, const interp_uint32* __restrict__ src0, const interp_uint32* __restrict__ src1, const interp_uint32* __restrict__ src2, unsigned count)
{
	unsigned i;
