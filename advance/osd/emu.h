...
#define ADV_COPY \
	"AdvanceMESS - Copyright (C) 2001-2018 by Andrea Mazzoleni\n" \
...
struct advance_input_state_context {
	...
	int simulate_key0; /**< Key code to simulate. 0 for none. */
	int simulate_key1; /**< Key code to simulate. 0 for none. */
...
struct advance_video_state_context {
	...
	double pipeline_timing_max; /**< Maximum time used to pipeline. */
	...
	double update_timing_min; /**< Minimum time used to update. */
