...
#define COMBINE_SCALE3X VIDEO_COMBINE_Y_SCALE3X
#define COMBINE_SCALE4X VIDEO_COMBINE_Y_SCALE4X
#define COMBINE_LQ2X VIDEO_COMBINE_Y_LQ2X
#define COMBINE_LQ3X VIDEO_COMBINE_Y_LQ3X
#define COMBINE_HQ2X VIDEO_COMBINE_Y_HQ2X
#define COMBINE_HQ3X VIDEO_COMBINE_Y_HQ3X
/*@}*/
