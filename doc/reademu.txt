...
and Linux with an advanced video support for helping the use with TVs,
Arcade Monitors, Fixed Frequencies Monitors and also for PC Monitors.
...
This package contains :
	advmame - The MAME emulator (only in the advanvemame-* package)
	advmess - The MESS emulator (only in the advanvemess-* package)
	advpac - The PAC emulator (only in the advanvepac-* package)
	...
	advk - The keyboard tester
	advline - The modeline generator
